...
namespace Core.Extensions
{
    public static class ClaimExtensions
    {
        ...
        public static void AddName(this ICollection<Claim> claims, string email)
        {
            claims.Add(new Claim(type:ClaimTypes.Name,value:"name"));
        }
        public static void AddNameIdentifier(this ICollection<Claim> claims, string addNameIdentifier)
        {
            claims.Add(new Claim(type: ClaimTypes.Name, value: "name"));
        }
